...
const NAV = [
  ...
  { href: "/subgroups", label: "Subgroups", num: "04" },
  { href: "/track", label: "Track", num: "05" },
  { href: "/present", label: "Present", num: "06" },
  { href: "/ask", label: "Ask", num: "07" },
  { href: "/preview", label: "Preview", num: "08" },
];
